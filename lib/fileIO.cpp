 ...
 */
Matrix readData(char *fname, int nc)
{
 ...
 * @return The data in a matrix format.
 */
Matrix readData(char *fname, int nc, int nr)
{
  Matrix data;                // matrix to store data
  char line[1024];            // temp array to store matrix line 
  char s[100];                // temp array to store one number
 ...
 * @param fname The file name.
 */
void writeData(Matrix &inmtx, char *fname)
{
  ofstream outfile;
  int i, j;
  int nr, nc; 
 ...
 */
Matrix readImage(char *fname, int *nrImg, int *ncImg)
{
  Matrix temp;
  FILE *fp;
  int i, j;
 ...
 */
void writeImage(char *fname, Matrix &img, int nrImg, int ncImg)
{
  FILE *fp;
  char dummy[80];
  int i, j, k;
